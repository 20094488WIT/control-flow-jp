...
fun minimumOf(number1: Long, number2: Long){
    ...
    if (number1 >= number2){
        ...
        println("$number1 is larger than or equal to $number2.")
    }
    else if (number1 < number2){

        println("$number1 is smaller than $number2.")
...
fun rangeOf(number: Int){
    ...
    when(number){
        in Int.MIN_VALUE..0 -> println("The number falls in the range 0 or below.")
        in 1..5 -> println("The number falls in the range 1 - 5.")
        in 6..10 -> println("The number falls in the range 6 - 10.")
        in 11..20 -> println("The number falls in the range 11 - 20.")
        in 21..Int.MAX_VALUE -> println("The number falls in the range 21+.")
